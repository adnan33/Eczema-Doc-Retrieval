...
def generate_data(queries_file, retrieval_results_path, suffix, keep_up_to_year):
    convert_to_utf(retrieval_results_path)
    ...
    for k in [100]:
        ...
        with open('interim_resources/bioasq_bm25_top{0}.{1}.pkl'.format(k, suffix), 'wb') as f:
        ...
        with open('interim_resources/bioasq_bm25_docset_top{0}.{1}.pkl'.format(k, suffix), 'wb') as f:
