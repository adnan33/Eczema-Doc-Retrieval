...
def load_all_data2(dataloc, idf_pickle_path, bert_all_words_path):
    print('loading pickle data')
    with open(dataloc+'alldata.json', 'r') as f:
        bioasq7_data = json.load(f)
        bioasq7_data = dict((q['id'], q) for q in bioasq7_data['questions'])
    #
    with open(dataloc + 'Eczema_bm25_top100.dev.pkl', 'rb') as f:
        dev_data = pickle.load(f)
    with open(dataloc + 'Eczema_bm25_docset_top100.dev.pkl', 'rb') as f:
        dev_docs = pickle.load(f)
    with open(dataloc + 'Eczema_bm25_top100.train.pkl', 'rb') as f:
        train_data = pickle.load(f)
    with open(dataloc + 'Eczema_bm25_docset_top100.train.pkl', 'rb') as f:
        train_docs = pickle.load(f)
    print('loading words')
    #
    if (os.path.exists(bert_all_words_path)):
...
odd                 = r'D:\aueb-bioasq7-master\Outputs\berttest\\'
#####################
idf_pickle_path             = './Data/PretrainedWeightsAndVectors/idf.pkl'
dataloc='./Data/combined_data/'
#####################
bert_all_words_path = './Data/PretrainedWeightsAndVectors/bert_all_words.pkl'
...
(dev_data, dev_docs, train_data, train_docs, idf, max_idf, bioasq6_data) = load_all_data2(
