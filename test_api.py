...
import  os, re, nltk, json, random, subprocess, pickle
import  torch
...
def anazitisi(idd, question):
    ...
    command = [sys.executable, 'runrun.sh']
    # print(' '.join(command))
...
###########################################################
#resume_from                 = 'Data\PretrainedWeightsAndVectors\bioasq_jpdrmm_2L_0p01_run_0\best_dev_checkpoint.pth.tar'
