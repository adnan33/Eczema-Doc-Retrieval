...
import  os, re, nltk, json, random, subprocess, pickle,ijson,io,chardet
import  torch
...
def get_documents_for_model(data, keep_up_to_year):
    ...
    docset = create_docset_es(results)
    return data,docset    
...
resume_from                 = 'Outputs/odd/bioasq_jpdrmm_test_0/best_dev_checkpoint.pth.tar'
###########################################################
#resume_from                 = r'D:\aueb-bioasq7-master\Data\PretrainedWeightsAndVectors\bioasq_jpdrmm_2L_0p01_run_0\best_dev_checkpoint.pth.tar'
#resume_from                 = r'D:\aueb-bioasq7-master\Outputs\best_dev_epoch20_checkpoint.pth.tar'
###########################################################
...
###########################################################
k_for_maxpool, k_sent_maxpool, embedding_dim = 5, 5, 30
###########################################################
my_seed     = 1
random.seed(my_seed)
...
print('loading idfs')
idf, max_idf = load_idfs(idf_pickle_path, wv.keys())
###########################################################
